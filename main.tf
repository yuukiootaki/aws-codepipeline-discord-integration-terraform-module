...
resource "aws_iam_role" "lambda_role" {
  name = "${var.APP_NAME}-discord-integration-lambda-role"
...
resource "aws_iam_role_policy" "lambda_role_policy" {
  name = "${var.APP_NAME}-discord-integration-lambda-role-policy"
...
resource "aws_cloudwatch_event_rule" "pipeline_state_update" {
  name        = "${var.APP_NAME}-discord-integration-pipeline-updated"
